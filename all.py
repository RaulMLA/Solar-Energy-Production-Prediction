...
mae_svm = metrics.mean_absolute_error(y_train_test_n, svm_preds)
rmse_svm = np.sqrt(metrics.mean_squared_error(y_train_test_n, svm_preds))
...
mae_rf = metrics.mean_absolute_error(y_train_test_n, rf_preds)
rmse_rf = np.sqrt(metrics.mean_squared_error(y_train_test_n, rf_preds))
